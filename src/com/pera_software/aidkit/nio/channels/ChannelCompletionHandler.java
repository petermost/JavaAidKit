...
public interface ChannelCompletionHandler< V, A > extends CompletionHandler< V, A > {
	public void handle( V value, Throwable exception, A attachment );

	@Override
	default void completed( V value, A attachment ) {
		handle( value, null, attachment );
	}

	@Override
	default void failed( Throwable exception, A attachment ) {
